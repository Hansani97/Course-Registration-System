...
<body class="bg-gradient-primary" style="background-image: url(&quot;assets/img/3433515.jpg&quot;);background-color: #001a33;">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-9 col-lg-12 col-xl-10" style="margin-bottom: 0px;margin-top: 0px;">
                <div class="card shadow-lg o-hidden border-0 my-5" data-aos="fade">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-password-image" data-aos="fade-up" style="background-image: url(&quot;assets/img/3275434.jpg&quot;);background-repeat: no-repeat;background-size: contain;background-position: center;"></div>
                            </div>
                            <div class="col-lg-6">
